...
<html>
    <head>
        ...
        <!-- FontAewsome -->
        <link href="<?php echo base_url('assets/fontawesome-free/fontawesome.css');?>" rel="stylesheet" />
															...
															<div class="row">
																	<div class="col-md-12 col-sm-12 col-xs-12">
																		<div class="float-right">
																			<a href="<?php echo site_url('admin/tambahkategori');?>" class="btn btn-default">Tambah Kategori</a>
																		</div>
